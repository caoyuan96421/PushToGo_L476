...
class ModSerial : private SerialBase, public FileHandle, private NonCopyable<ModSerial> {

public:

    /** Create a ModSerial port, connected to the specified transmit and receive pins, with a particular baud rate.
     *  @param tx Transmit pin
     *  @param rx Receive pin
     *  @param baud The baud rate of the serial port (optional, defaults to MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE)
     */
    ModSerial(PinName tx, PinName rx, int baud = MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE);
    virtual ~ModSerial();
     ...
     */
    void set_format(int bits = 8, Parity parity = ModSerial::None, int stop_bits = 1);
...
//    void disable_tx_irq();
     ...
     */
    OutputQueue<unsigned char, MBED_CONF_DRIVERS_UART_SERIAL_TXBUF_SIZE> _txqueue;
    InputQueue<unsigned char, MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE> _rxqueue;
...
//    void rx_irq(void);
    ...
    void rx_complete_cb(int flag);
    void tx_complete_cb(int flag);

    static void inotify(InputQueue<unsigned char, MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE> *, void *);
    static void onotify(OutputQueue<unsigned char, MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE> *, void *);
